...
def caltech_train_loader():
    return Caltech101(
        "/srv/share/datasets/caltech101", train=True, transform=caltech_train_transform
    )


def caltech_test_loader():
    return Caltech101(
        "/srv/share/datasets/caltech101", train=False, transform=caltech_test_transform
    )


def prepare_train_loaders(config):
    return {"full": caltech_train_loader()}


def prepare_test_loaders(config):
    return {"full": caltech_test_loader()}
