...
class StanfordDogs(Dataset):
    ...
    def __init__(self, root, train=True, transform=None, download=False, base_set=None):
        self.root_og = root
...
def stanford_dogs_train_loader():
    return StanfordDogs(
        "/srv/share/datasets/stanford_dogs",
        train=True,
        transform=stanford_dogs_train_transform,
    )
...
def stanford_dogs_test_loader():
    return StanfordDogs(
        "/srv/share/datasets/stanford_dogs",
        train=False,
        transform=stanford_dogs_test_transform,
    )
